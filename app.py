...
# Load the model package once globally
...
# Infer feature metadata for UI generation
feature_metadata = []
for feature in feature_columns:
    if feature in label_encoders:
        ...
        # Optionally, compute min/max from scaler or set domain manually here
...
def predict_health_risk(age, gender, bmi, smoking_status, alcohol_intake_per_week, 
    ...
    """
    Predict health risk level for given parameters using loaded model_data.
    Returns: (predicted_class, probability_scores, target_classes)
    """
    input_data = {
        'age': age,
        'gender': gender,
    ...
    # Create feature vector following feature_columns order
